...
\begin{proof}
    ...
    \begin{align}
        ...
        &= 0.
    \end{align}
    This last step relies on the use of random eigenvalues with mean 0, implying $\int D ~dD = 0$. Since the partial trace of 0 is 0, this shows that $\frac{\partial}{\partial \alpha} \Phi(\rho_S) \big|_{\alpha = 0 } = 0$.
\end{proof}
...
\begin{align}
    ...
    &~ + e^{i(H+\alpha G)t} \rho_T \int_{0}^1 e^{-i s (H+\alpha G) t} (- i t G) e^{-i (1-s) (H+\alpha G)t} ds \bigg|_{\alpha = 0} \\
