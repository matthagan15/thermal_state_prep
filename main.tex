...
\end{align}
From here we use the fact that partial traces, integrations, and our anticommutator is linear in one of the inputs to pull the averaging over $G$ into the commutator. Then we use the fact that any given $G$ can be written as $G = U_G D U_G^\dagger$ to yield
\begin{align}
