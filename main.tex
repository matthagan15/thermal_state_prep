...
\end{align}
Our last step is to decompose each factor into phase, eigenvalue, or Haar contributions. We do so with the following breakdown
\begin{align}
    ...
    &= \sum_{i,j,k,l,m,n} e^{i (\lambda(i,j) - \lambda(k,l))x} D(m,n) \bra{i,j} U_G \ket{m,n} \bra{k,l} \overline{U_G} \ket{m,n} ~\ketbra{i,j}{k,l}.
\end{align}
The product of two time-evolved random interactions is then 
\begin{align}
    G(x) G(y) &= \sum_{i,j,k,l,m,n} e^{i (\lambda(i,j) - \lambda(k,l))x} D(m,n) \bra{i,j} U_G \ket{m,n} \bra{k,l} \overline{U_G} \ket{m,n} \ketbra{i,j}{k,l} \nonumber \\
    &~ \times \sum_{a,b,c,d,e,f} e^{i(\lambda(a,b) - \lambda(c,d))y} D(e,f) \bra{a,b} U_G \ket{e,f} \bra{c,d} \overline{U_G} \ket{e,f} \ketbra{a,b}{c,d} \\ 
    &= \sum_{i,j,k,l,m,n} \sum_{c,d,e,f} \bigg[ e^{i(\lambda(i,j) - \lambda(k,l))x} e^{i(\lambda(k,l) - \lambda(c,d))y} D(m,n) D(e,f) \nonumber \\
    & \quad \bra{i,j} U_G \ket{m,n} \bra{k,l} \overline{U_g} \ket{m,n} \bra{k,l} U_G \ket{e,f} \bra{c,d} \overline{U_G} \ket{e,f} \bigg] \ketbra{i,j}{c,d}.
\end{align}
...
\begin{align}
    C_\lambda(i,j,k,l,c,d; x, y) &\coloneqq e^{i(\lambda(i,j) - \lambda(k,l))} e^{i(\lambda(k,l) - \lambda(c,d))y} \\
    C_D(m,n,e,f) &\coloneqq D(m,n) D(e,f) \\
    C_U(i,j,k,l,m,n,c,d,e,f) &\coloneqq \bra{i,j} U_G \ket{m,n} \bra{k,l} \overline{U_g} \ket{m,n} \bra{k,l} U_G \ket{e,f} \bra{c,d} \overline{U_G} \ket{e,f}.
\end{align}
