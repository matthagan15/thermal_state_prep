...
Starting with safe parameter choices of $\Delta = \gamma = 1$, $\alpha = 0.001$, $t = 100.0$, and $\beta = 3.0$ we show how a harmonic oscillator truncated to the $4$ lowest energy levels thermalizes. 
