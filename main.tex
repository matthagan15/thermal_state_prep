...
\begin{lemma}
    The following "four-element" Haar integral can be computed as 
    \begin{align}
        \int dU \bra{i_1} U \ket{j_1} ~ \bra{i_2} U \ket{j_2} ~ \overline{\bra{k_1} U \ket{l_1}}  ~ \overline{\bra{k_2} U \ket{l_2} }  = \\
        \frac{1}{\dim^2 - 1}\parens{\delta_{i_1, k_1} \delta_{i_2, k_2} \delta_{j_1, l_1} \delta_{j_2, l_2} + \delta_{i_1, k_2}  \delta_{i_2, k_1} \delta_{j_1, l_2} \delta_{j_2, l_1}} \\
        - \frac{1}{\dim (\dim^2 - 1)} \parens{\delta_{i_1, k_2} \delta_{i_2, k_1} \delta_{j_1, l_1} \delta_{j_2, l_2} + \delta_{i_1, k_1} \delta_{i_2, k_2} \delta_{j_1, l_2} \delta_{j_2, l_1}} 
    \end{align}
\end{lemma}
