...
\begin{align}
    ...
    \bra{b} \Phi(\ketbra{a}{a}) \ket{b} \frac{(\dim + 1) \partfun_E(\beta)}{2 \alpha^2 \sigma^2} &= \frac{1 - \cos ( \Delta(a, 0 | b, 0) t)}{\Delta(a, 0 | b, 0)} + \frac{1 - \cos ( \Delta(a, 0 | b, 1) t)}{\Delta(a, 0 | b, 1)} \nonumber \\
    &~ + e^{-\beta \gamma} \frac{1 - \cos ( \Delta(a, 1 | b, 0) t)}{\Delta(a, 1 | b, 0)} + e^{-\beta \gamma} \frac{1 - \cos ( \Delta(a, 1 | b, 1) t)}{\Delta(a, 1 | b, 1)} \\
    &= \frac{1 - \cos(\Delta_S(a,b)t)}{\Delta_S(a,b)^2}(1 + e^{-\beta \gamma}) \nonumber \\
    &+ \frac{1 - \cos((\Delta_S(a,b) - \gamma)t)}{(\Delta_S(a,b) - \gamma)^2} + e^{-\beta \gamma} \frac{1 - \cos((\Delta_S(a,b) + \gamma)t)}{(\Delta_S(a,b) + \gamma)^2}.
\end{align}
...
\begin{align}
    ...
    &+\frac{1 - \cos((\Delta_S(a,b) + \gamma)t)}{(\Delta_S(a,b) + \gamma)^2}(e^{-\beta \gamma} - 1)
\end{align}
