...
Could I get a better norm result with the same scaling? Aka can I bound the one or two norm of $R_{\Phi}$ with the same scaling?
...
\end{equation}
Now we can bound $\norm{R_{\Phi}}_2 \leq \sqrt{\dim} \norm{R_{\Phi}} \leq \epsilon_{R} \sqrt{\dim}$. Note we can improve this bound with improvements to the $\norm{B}_2$ bound. This is computed below.
