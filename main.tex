...
\begin{equation}
    \int dU_G \bra{i,j} U_G \ket{i',j'} \bra{m,n} U_G \ket{k',l'}  \overline{\bra{m,n} U_G \ket{i',j'}}   ~\overline{\bra{k,l} U_G \ket{k',l'}}  = \frac{-\delta_{i,k} \delta_{j,l}}{\dim_{env\otimes sys} (\dim_{env \otimes sys}^2 - 1)}
\end{equation}
