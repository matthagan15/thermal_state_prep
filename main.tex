...
\subsection{Hydrogen Chain Numerics - DEFCON 3} \label{sec:general_numerics}
...
The first behavior we explore is how the distance to our target thermal state decreases with respect to the number of interactions $L$. 
...
%     \end{subfigure}
    \centering
    % \begin{subfigure}{0.49\textwidth}
    %     \includegraphics[width=\textwidth]{numerics/data/error_vs_interaction_h_chain.pdf}
    %     \caption{H2 }
    % \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
