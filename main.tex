...
\end{align}
This is not particularly useful. However, if we make the assumption that $\sigma \to 0$ then we can use the fact that the lower bound for $t$ approaches $\frac{1}{\Delta \sqrt{\epsilon}}$, giving
\begin{equation}
    \lim_{\sigma \to 0} Lt = \frac{10 J}{\Delta \epsilon^{2.5}}.
\end{equation}
 \end{proof}
