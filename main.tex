...
\matt{Current structure is OK, needs to be much shorter and skip more of the background. More comparisons with other techniques, specifically gilyen glauber dynamics, needs to be done.}
...
\centering
    ...
    \end{subfigure} \\ 
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width = \textwidth]{numerics/data/h_chain_with_noise_1.png}    
        \caption{Hydrogen 2 } \label{fig:h2_chain_with_noise}
    \end{subfigure}    
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\textwidth]{numerics/data/h_chain_3_with_noise_2.png}
    ...
    Effects of noise added to exact spectrum sampling for Hydrogen chains, H2 on left and H3 on right. As we can see both tend to increase and then plateau. The parameters of these plots are $\beta = 1.0$, $\alpha = 0.01$, and $t = 150$ for H2 and $t = 200$ for H3.}
