...
\begin{theorem} \label{thm:single_qubit}
    ...
    % . By setting $\alpha = \frac{1}{\Delta^2 t^3}$, if $L$ and $t$ satisfy the following lower bounds
    % \begin{equation}
