...
def channel(beta1, beta2, time, alpha, dim1=10, dim2=10):
    oscillator1 = harmonic_oscillator_hamiltonian(dim1)
    oscillator2 = harmonic_oscillator_hamiltonian(dim2)
    rho = np.kron( thermal_state(oscillator1, beta1), thermal_state(oscillator2, beta2))
...
def test():
    ...
    t = 1.
    alpha = 0.1
    out = channel(b1, b2, t, alpha, dim1=d1, dim2=d2)
